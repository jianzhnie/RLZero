...
from .utils import (MIN_TRIPLES, TYPE_0_PASS, TYPE_1_SINGLE, TYPE_2_PAIR,
                    TYPE_3_TRIPLE, TYPE_4_BOMB, TYPE_5_KING_BOMB, TYPE_6_3_1,
                    TYPE_7_3_2, TYPE_8_SERIAL_SINGLE, TYPE_9_SERIAL_PAIR,
...
def get_move_type(move):
    ...
    if move_size == 6:
        if ((len(move_dict) == 2 or len(move_dict) == 3)
                and count_dict.get(4) == 1
                and (count_dict.get(2) == 1 or count_dict.get(1) == 2)):
            return {'type': TYPE_13_4_2, 'rank': move[2]}

    if move_size == 8 and (
        ((len(move_dict) == 3 or len(move_dict) == 2) and
         (count_dict.get(4) == 1 and count_dict.get(2) == 2))
    ...
    if count_dict.get(3, 0) >= MIN_TRIPLES:
        ...
        if is_continuous_seq(serial_3):
            ...
            if len(serial_3) == len(pair) and len(
                    move_dict) == len(serial_3) * 2:
                return {
