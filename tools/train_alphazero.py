...
class TrainPipeline:
    def __init__(self):
        ...
        self.board_size = 6
        self.n_in_row = 4
        self.board = GomokuEnv(board_size=self.board_size, n_in_row=self.n_in_row)
        self.game = GameControl(self.board)
        # training params
        ...
        for state, mcts_porb, winner in play_data:
            for i in [1, 2, 3, 4]:
                ...
                equi_mcts_prob = np.rot90(
                    np.flipud(mcts_porb.reshape(self.board_size, self.board_size)), i
                )
                extend_data.append(
    ...
    def policy_update(self):
        ...
        for i in range(self.epochs):
            loss, entropy = self.alphazero_agent.learn(
